...
const _navOrther = [
  ...
  },
  {
    ...
    to: "/admin-config-web",
    icon: (
      <CgWebsite style={css} name="cil-user" className="c-sidebar-nav-icon" />
    ),
    role: ["0"],
    badge: {
      color: "info",
  ...
  },
  {
    ...
    to: "/profile",
    icon: (
      <CIcon style={css} name="cil-user" customClasses="c-sidebar-nav-icon" />
    ),
    role: ["0", "1", "2", "5"],
    badge: {
      color: "info",
  ...
  },
  {
    ...
    to: "/role_manager",
    icon: (
      <CIcon style={css} name="cil-people" customClasses="c-sidebar-nav-icon" />
    ),
    role: ["0"],
    badge: {
      color: "info",
