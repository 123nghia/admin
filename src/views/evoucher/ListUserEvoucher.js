            ...
            <Col>
              <Card>
                <CardHeader>
                  ...
                  <i className="fa fa-align-justify title_header">Danh sách người sử dụng</i>
                  ...
                  <table ble className="table table-hover table-outline mb-0 d-none d-sm-table table_dash">
                    <thead className="thead-light">
                      <tr>
                        ...
                        <th className="text-center">Voucher sử dụng</th>
                          ...
                          data.map((item, i) => {
                            return (
                              <tr key={i}>
                                ...
                                <td className="text-center">{item.usingVoucher}</td>
