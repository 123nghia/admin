...
import ListCustomer from "./TabContent/ListCustomer";

import Statistic from "./TabContent/Statistic";
...
import Info from './TabContent/Info';
...
class Users extends Component {
  ...
  async getDetailInfoCustomer(id) {
    var baseUrlapi = Constants.BASE_URL;
    let baseUrlCallApi = Constants.PARTNER_GET_DETAI_COLLABORATOR;
    ...
    await axios
      ...
      .then((res) => {
        ...
        this.setState({ infoCustomer: val })
        this.setState({ isLoading: false, phoneUserCurrent : val.phone });
       
      });
  }
  async getAllCustomer() {
    var baseUrlapi = Constants.BASE_URL;
    let baseUrlCallApi = Constants.COLLABORATOR_GET_LIST;

    let url = baseUrlapi + baseUrlCallApi;
    await axios
      .post(url, {
        saleId: this.state.phoneUserCurrent,
      })
      .then((res) => {
        let val = res.data.data;
        // console.log("val", val);
        this.pagination(val);
        this.setState({ listCustomer: val });
        let active = 0;
  ...
  async getStatistic(id) {
    var baseUrlapi = Constants.BASE_URL;
    let baseUrlCallApi = Constants.PARTNER_GET_STATISTIC_COLLABORATOR;
    let url = baseUrlapi + baseUrlCallApi;
    await axios
      .get(url, {
        id: id,
      ...
      .then((res) => {
        let val = res.data.data;
        this.setState({ dataStatistic: val });
      });
  }
  async componentDidMount() {
    await this.getDetailInfoCustomer(this.props.match.params.id);
    await this.getAllCustomer(this.props.match.params.id);
    await this.getStatistic(this.props.match.params.id);
        ...
        <div className="animated fadeIn">
          <div className="flex-tabs">
            ...
            <div className="tabcontents">
              ...
              {this.state.dataStatistic ? (
                  <Statistic
                    dataStatistic={this.state.dataStatistic}
                  />
                ) : null}
                </div>
                <div id="tabcontent3" className="tabcontent ">
              {this.state.infoCustomer !== undefined ? (
                  <Info
