...
class EndUser extends Component {
  ...
  getData = async () => {
    ...
    let val = [
      {
          title : "Banner",
          img : "https://rubicmarketing.com/wp-content/uploads/2021/07/banner-quang-cao-facebook-3.jpg",
          link : "google.com",
            ...
            <Col>
              <Card>
                <CardHeader>
                  ...
                  <i className="fa fa-align-justify title_header">Quản lý Banner Quảng cáo</i>
                          ...
                          data.map((item, i) => {
                            return (
                              ...
                              <td className="text-center">{i + 1}</td>
                                ...
                                <img style={{ maxWidth : "400px" }} alt="" src={item.img}/>

                                </td>
                                <td className="text-center"><a target="_blank" href={item.link}>{item.link}</a></td>
