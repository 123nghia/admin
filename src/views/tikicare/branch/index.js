...
class Products extends Component {
  ...
  async update() {
    ...
    var baseUrlapi = Constants.BASE_URL;
    let baseUrlCallApi = Constants.UPDATE_BRAND;
  ...
  async add() {
    ...
    var baseUrlapi = Constants.BASE_URL;
    let baseUrlCallApi = Constants.ADD_BRAND;
    let url = baseUrlapi + baseUrlCallApi;
    await axios
      .post(url, {
        title: title,
  ...
  async delete(item) {
    let baseUrlCallApi = Constants.DELETE_BRAND;
    var baseUrlapi = Constants.BASE_URL;
    let url = baseUrlapi + baseUrlCallApi;
    await axios
      .delete(url, {
    ...
    if (!this.state.isLoading) {
      return (
        <div className="animated fadeIn">
          <Modal closeButton toggle={()=>this.setState({modal : false})} isOpen={this.state.modal} className={this.props.className}>
