...
async openFormEditProduct(item){
  ...
  async saveEdit() {
    ...
    await axios.post(url, {
        ...
        if(this.state.typeCurrentUpdate === "0"){
            this.getDataColegen();
        }else{
            this.getDataNamda();
        }
        ...
        return (
          <tr key={i}>
            ...
            <td className="text-center">
              {item.level === "1" ? "1-3" : item.level === "2" ? "4-5" : "6-8"}
            </td>
      ...
      let render = (
          <div className="bg_panel">
            ...
            <CButton
              ...
              color="info"
              size="md"
              onClick={() => this.openFormAdd(data[0]._type)}
            >
              {/* <CIcon name="cilTrash" /> */}
              Thêm mới
            </CButton>{" "}
            ...
            <TabPanel  value={valueTabs} index={2}>
              <Box sx={{ width: "100%" }}>
                ...
                <TabPanel value={valueOverview} index={0}>
                  {this.renderData(dataColegenTemp)}
                </TabPanel>
                <TabPanel value={valueOverview} index={1}>
                  {this.renderData(dataNamTemp)}
                </TabPanel>
              </Box>
            </TabPanel>
