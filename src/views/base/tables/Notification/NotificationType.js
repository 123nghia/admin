...
class NotificationType extends Component {
  ...
  async addNotificationType() {
    ...
    const res = await axios({
      baseURL: Constants.BASE_URL,
      url: Constants.ADD_NOTIFICATION_TYPE,
      method: 'POST',
      data: body
    });
  ...
  async updateLocation() {
    ...
    const res = await axios({
      baseURL: Constants.BASE_URL,
      url: Constants.UPDATE_NOTIFICATION_TYPE,
      method: 'POST',
      data: body
    });
  ...
  async delete() {
    ...
    const res = await axios({
      baseURL: Constants.BASE_URL,
      url: Constants.DELETE_NOTIFICATION_TYPE,
      method: 'POST',
      data: {
        "id": this.state.id
      }
      ...
      return (
        <div className="animated fadeIn">
          ...
          <Modal isOpen={this.state.modalCom} className={this.props.className}>
            ...
            <ModalFooter>
              <CButton color="primary" onClick={e => { this.state.action === 'new' ? this.addNotificationType() : this.updateLocation() }} disabled={this.state.isLoading}>Lưu</CButton>{' '}
