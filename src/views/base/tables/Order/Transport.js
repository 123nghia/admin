...
class Transport extends Component {
  ...
  getData = async () => {
    ...
    const resLocation = await axios({
      ...
      url: Constants.GET_LIST_TRANSPORT,
      data: {
                  ...
                  <table ble className="table table-hover table-outline mb-0 d-none d-sm-table">
                    <thead className="thead-light">
                      <tr>
                        ...
                        <th className="text-center">Thời gian nhận hàng</th>
                        <th className="text-center">Thời gian giao hàng</th>
                      </tr>
                    </thead>
                    <tbody>
                          ...
                          data.map((item, i) => {
                            return (
                              <tr key={i}>
                                ...
                                <td className="text-center">
                                  {item.estimated_pick_time}
                                </td>
                                <td className="text-center">
                                  {item.estimated_deliver_time}
                                </td>
                              </tr>
                            );
                          }) : ""
