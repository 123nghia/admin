...
class SuggestItem extends Component {
  ...
  onSearch = async () => {
    ...
    if (type == '0' || type == '1') {
      ...
      const res_suggest = await API_CONNECT(
        //http://192.168.1.59:3002/itemSdk/search/611f1461ef623903dbb4f75d/1?&key=c
                              ...
                              data.map((item, i) => {
                                return (
                                    ...
                                    <td className="text-center">
                                      {
                                        item.image_link == null || item.image_link == "" ? <img src={`${item.image}`} width={"60px"} height={"60px"} /> :
                                          <img src={`http://192.168.1.59:3002/public/image_plugin/${item.image_link}`} width={"60px"} height={"60px"} />
                                      }
                                    </td>
                                  ...
                                  <a href={item.linkdetail} target="_blank">{item.linkdetail}</a>
                                    ...
                                    {/* <td className="text-center">
                                      {<img src={`http://192.168.1.59:3002/public/image_brand/${item.brand_id.image_link}`} width={"60px"} height={"60px"} />}
                                    </td> */}
                                    {/* <td className="text-center">
              ...
              />
              {
                this.state.image == "" ? "" :
                  <img width="250" height="300" src={
                    this.state.image_show == "" ? `http://192.168.1.59:3002/public/image_plugin/${this.state.image_link}` : this.state.image} style={{ marginBottom: 20 }} />
              }
