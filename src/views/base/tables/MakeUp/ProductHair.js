                                ...
                                return (
                                  <tr key={i}>
                                    ...
                                    <td className="text-center" style={{ width: '10%' }}>
                                      {
                                        <img src={item.image_link == null ? item.image : `http://192.168.1.59:3002/public/image_makeup/${item.image_link}`} width={"60px"} height={"60px"} />
                                      }
                                    </td>
                                    <td className="text-center">
                    ...
                    />
                    {
                      this.state.image == "" ? "" :
                        <img width="250" height="300" src={
                          this.state.image_show == "" ? `http://192.168.1.59:3002/public/image_makeup/${this.state.image_link}` : this.state.image
