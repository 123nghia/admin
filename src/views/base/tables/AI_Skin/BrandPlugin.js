                                ...
                                <td className="text-center">
                                  {
                                    item.image_link == null || item.image_link == "" ? <img src={`${item.image}`} width={"60px"} height={"60px"} /> :
                                      <img src={`http://192.168.1.59:3002/public/image_brand/${item.image_link}`} width={"60px"} height={"60px"} />
                                  }
                                </td>
                                <td className="text-center">
              ...
              />
              {
                this.state.image == "" || this.state.image == null || this.state.image == undefined ?
                  ...
                  <img width="250" height="300" src={
                    this.state.image_show == "" ? `http://192.168.1.59:3002/public/image_brand/${this.state.image_link}` : this.state.image} style={{ marginBottom: 20 }} />
              }
