...
class User extends Component {
  ...
  getLableRole(type) {
    switch (type) {
      case "0":
        return "Quản lý soi da";
      case "1":
        return "Quản lý trang điểm và tóc";
      case "2":
      ...
      return (
        <div className="animated fadeIn">
          ...
          <Modal
            ...
            toggle={(e) => this.setState({ modalRole: !this.state.modalRole })}
                ...
                return (
                  <CFormGroup variant="checkbox" className="checkbox">
                    <CInputCheckbox
                      id={item}
                      defaultChecked={
                        arrRoleSubAdmin.includes(item) == true ? true : false
                      }
                      name={item}
                      value={item}
                      onChange={(e) => {
