        ...
        <div className="animated fadeIn">
          <Row>
            <Col>
              ...
              <Card>
                <CardHeader>
                  <i className="fa fa-align-justify"></i> Danh sách giao dich
              ...
              <Card>
                <CardHeader>
                  <i className="fa fa-align-justify"></i> Chi tiết giao dịch của {this.state.currenCom} (Mã công ty: {this.state.currenCom_ID})
                </CardHeader>
                <CardBody>
                  <table ble className="table table-hover table-outline mb-0 d-none d-sm-table">
                    <thead className="thead-light">
